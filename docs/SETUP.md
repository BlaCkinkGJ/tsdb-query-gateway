...
- **Downstream timeout** — Use less complex queries. (Note: the gateway currently uses a hardcoded 30s HTTP timeout; making this configurable via the config file is a recommended future improvement.)
